	...
	return (
		...
		>
			<div className={styles.content__image}>
				<Image src={image} alt={title} width={2000} height={200} />
			</div>
			<div className={styles.content__text}>{formatText(text) || 'Документ не найден'}</div>
			<RdxDialogClose asChild>
				<button className={styles.modal__close} type="button" aria-label="Закрыть окно">
					Закрыть
				</button>
			</RdxDialogClose>
		</UiDialog>
