...
- из корня репозитория: `yarn check:risk:local` (включает **`report:decomposition-threshold --fail-on-violations`**, **REF-PREM-01**; или согласно регламенту pre‑push в проекте).
