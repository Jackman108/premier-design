...
| [OPERATIONS_OBSERVABILITY_RU.md](OPERATIONS_OBSERVABILITY_RU.md) | RISK-11: `correlationId`, логи, SLO feedback. |
| [SUPPLY_CHAIN_RU.md](SUPPLY_CHAIN_RU.md) | RISK-09: зависимости, weekly, lockfile. |
| [CI_COST_AND_TRENDS_RU.md](CI_COST_AND_TRENDS_RU.md) | RISK-12: тренды CI, p95, вынесенные e2e. |

Обновление: при закрытии пункта бэклога — `premier-design/CHANGELOG.md`; при появлении новых FSD-отклонений или визуальных задач — соответствующие разделы в `PROJECT_AUDIT_2026_04_RU.md` или `AUDIT_AND_IMPROVEMENT_PLAN_RU.md`.
