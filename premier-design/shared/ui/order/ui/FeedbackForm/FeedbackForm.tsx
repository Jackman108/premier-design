		...
		<form className={styles.form} onSubmit={handleSubmit} noValidate>
			<div className={styles.form__main}>
				<div className={styles.form__nameEmail}>
					<div className={styles.input__group}>
						...
						/>
						{errors.name && (
							<div id="feedback-name-error" className={styles.errorMessage} role="alert">
								{errors.name}
							</div>
						)}
					</div>
					<div className={styles.input__group}>
						...
						/>
						{errors.email && (
							<div id="feedback-email-error" className={styles.errorMessage} role="alert">
								{errors.email}
							</div>
						)}
					</div>
				...
				<div className={styles.input__group}>
					...
					/>
					{errors.message && (
						<div id="feedback-message-error" className={styles.errorMessage} role="alert">
							{errors.message}
						</div>
					)}
				</div>
			...
			<div className={styles.form__footer}>
				<div className={styles.input__group}>
					...
					/>
					{errors.consent && (
						<div id="feedback-consent-error" className={styles.errorMessage} role="alert">
							{errors.consent}
						</div>
					)}
				</div>
