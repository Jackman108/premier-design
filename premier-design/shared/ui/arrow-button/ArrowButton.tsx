	...
	return (
		<div className={styles.arrow__buttons}>
			<button className={styles.arrow__button} aria-label="Стрелка влево">
				<Image src={costingButton.src} alt="" width={32} height={32} className={styles.arrow__left} />
			</button>
			<button className={styles.arrow__button} aria-label="Стрелка вправо">
				<Image src={costingButton.src} alt="" width={32} height={32} className={styles.arrow__right} />
			</button>
		</div>
	);
};
