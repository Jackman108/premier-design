...
export const ProjectOffer = dynamic(() => import('@features/project-offer/ui/ProjectOffer/ProjectOffer'), {loading: SectionSkeleton});
export const Partners = dynamic(() => import('@features/partners/ui/Partners/Partners'), {loading: SectionSkeleton});
export const StepsWork = dynamic(() => import('@features/steps-work/ui/StepsWork/StepsWork'), {loading: SectionSkeleton});
...
export const BusinessServices = dynamic(() => import('@features/business-services/ui/BusinessServices/BusinessServices'), {loading: SectionSkeleton});
export const Category = dynamic(() => import('@features/category/ui/Category/Category'), {loading: SectionSkeleton});
export const RelatedServices = dynamic(() => import('@features/related-services/ui/RelatedServices/RelatedServices'), {loading: SectionSkeleton});
export const Reviews = dynamic(() => import('@shared/ui/reviews/ui/Reviews/Reviews'), {loading: SectionSkeleton});
export const TrustSignals = dynamic(() => import('@features/marketing/trust-signals/ui/TrustSignals'), {loading: SectionSkeleton});
export const LeadQuiz = dynamic(() => import('@features/marketing/lead-quiz/ui/LeadQuiz'), {loading: SectionSkeleton});
export const FaqSection = dynamic(() => import('@features/faq/ui/FaqSection'), {loading: SectionSkeleton});
export const VideoSpotlight = dynamic(() => import('@features/marketing/video-spotlight/ui/VideoSpotlight'), {loading: SectionSkeleton});
