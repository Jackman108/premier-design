...
const chatbotConfig = {
	...
	customComponents: {
		header: () => <div className={chatbotHeaderStyles.header}>Ваш консультант {BOT_NAME}</div>,
		botAvatar: (props: CustomAvatarProps) => <CustomAvatar {...props} src={BOT_AVATAR_PATH} alt="Bot Avatar" />,
		userAvatar: (props: CustomAvatarProps) => <CustomAvatar {...props} src={USER_AVATAR_PATH} alt="User Avatar" />,
	},
};
