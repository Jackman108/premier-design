	...
	<>
		...
		<div className={styles.content}>
			<p>
				...
				действует в отношении всей информации, которую Интернет-ресурс по ремонту, дизайну интерьера, отделке
				помещений и квартир в Республике Беларусь, расположенный на доменном имени {SITE_PUBLIC_ORIGIN}/.может
				получить о Пользователе во время использования сайта Интернет-ресурс по ремонту, дизайну интерьера,
				отделке помещений и квартир в Республике Беларусь, программ и продуктов Интернет-ресурса.
			</p>
			<h2>1. Определение терминов</h2>
			<p>1.1. В настоящей Политике конфиденциальности используются следующие термины:</p>
			<p>
				1.1.1. «Администрация сайта Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений и квартир в
				Республике Беларусь (далее – Администрация сайта)» – уполномоченные сотрудники на управления сайтом,
				действующие от имени {SITE_OPERATOR.legalEntityShortName}, которые организуют и (или) осуществляет
			...
			<p>
				1.1.5. «Пользователь сайта Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений и квартир в
				Республике Беларусь (далее - Пользователь)» – лицо, имеющее доступ к Сайту, посредством сети Интернет и
				использующее Сайт Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений и квартир в
				Республике Беларусь.
			</p>
			<p>
			...
			<p>
				2.1. Использование Пользователем сайта Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений
				и квартир в Республике Беларусь., означает согласие с настоящей Политикой конфиденциальности и условиями
				обработки персональных данных Пользователя. В случае несогласия с условиями Политики конфиденциальности
				Пользователь должен прекратить использование сайта Интернет-ресурс по ремонту, дизайну интерьера,
				отделке помещений и квартир в Республике Беларусь.
			</p>
			<p>
				2.2. Настоящая Политика конфиденциальности применяется только к сайту Интернет-ресурс по ремонту,
				дизайну интерьера, отделке помещений и квартир в Республике Беларусь
				{SITE_PUBLIC_ORIGIN}/. Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений и квартир в
				Республике Беларусь не контролирует и не несет ответственность за сайты третьих лиц, на которые
				Пользователь может перейти по ссылкам, доступным на сайте Интернет-ресурс по ремонту, дизайну интерьера,
				отделке помещений и квартир в Республике Беларусь.
			</p>
			<p>
				2.3. Администрация сайта не проверяет достоверность персональных данных, предоставляемых Пользователем
				сайта Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений и квартир в Республике Беларусь.
			</p>
			<h2>3. Предмет политики конфиденциальности</h2>
			<p>
				3.1. Настоящая Политика конфиденциальности устанавливает обязательства Администрации сайта
				Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений и квартир в Республике Беларусь, по
				неразглашению и обеспечению режима защиты конфиденциальности персональных данных, которые Пользователь
				предоставляет по запросу Администрации сайта при регистрации на сайте Интернет-ресурс по ремонту,
				дизайну интерьера, отделке помещений и квартир в Республике Беларусь, или при оформлении заказа для
				приобретения Услуги или товара.
			</p>
			<p>
				3.2. Персональные данные, разрешённые к обработке в рамках настоящей Политики конфиденциальности,
				предоставляются Пользователем путём заполнения регистрационной формы на Сайте Интернет-ресурс по
				ремонту, дизайну интерьера, отделке помещений и квартир в Республике Беларусь, {SITE_PUBLIC_ORIGIN}/. в
				разделах Формы оформления заказа и Формы подписки на рассылку и включают в себя следующую информацию:
			</p>
			<ul>
			...
			<p>
				3.3. Интернет-ресурс защищает Данные, которые автоматически передаются в процессе просмотра рекламных
			...
			<ul>
				...
				<li>Референт (адрес предыдущей страницы).</li>
			</ul>
			<p>
				3.3.1. Отключение cookies может повлечь невозможность доступа к частям сайта Интернет- ресурса,
				требующим авторизации.
			</p>
			<p>
				3.3.2. Интернет-ресурс по ремонту, дизайну интерьера, отделке помещений и квартир в Республике Беларусь
			...
			<p>
				4.1. Персональные данные Пользователя Администрация сайта интернет-ресурса может использовать в целях:
			</p>
			<ul>
				<li>
					Идентификации Пользователя, зарегистрированного на сайте Интернет-ресурс по ремонту, дизайну
					интерьера, отделке помещений и квартир в Республике Беларусь, для оформления заказа и (или)
					заключения Договора купли-продажи услуги или товара дистанционным способом с{SITE_PUBLIC_ORIGIN}/.
				</li>
				<li>Предоставления Пользователю доступа к персонализированным ресурсам Сайта интернет-ресурса.</li>
				<li>
					Установления с Пользователем обратной связи, включая направление уведомлений, запросов, касающихся
					использования Сайта интернет-ресурса, оказания услуг, обработка запросов и заявок от Пользователя.
				</li>
				<li>
				...
				<li>
					Создания учетной записи для совершения покупок, если Пользователь дал согласие на создание учетной
					записи.
				</li>
				<li>Уведомления Пользователя Сайта интернет-ресурса о состоянии Заказа.</li>
				<li>
				...
				<li>
					...
					проблем, связанных с использованием Сайта интернет-ресурса.
				</li>
				<li>
					Предоставления Пользователю с его согласия, обновлений продукции, специальных предложений,
					информации о ценах, новостной рассылки и иных сведений от имени Интернет- ресурса или от имени
					партнеров Интернет-ресурса.
				</li>
				<li>Осуществления рекламной деятельности с согласия Пользователя.</li>
				<li>
					Предоставления доступа Пользователю на сайты или сервисы партнеров Интернет- ресурса с целью
			...
			<p>
				...
				третьим лицам, в частности, операторам электросвязи, исключительно в целях выполнения заказа
				Пользователя, оформленного на Сайте интернет-ресурса
				{SITE_PUBLIC_ORIGIN}/, включая оказание услуги.
			</p>
			<p>
				5.3. Персональные данные Пользователя могут быть переданы уполномоченным органам государственной власти
				Республики Беларусь только по основаниям и в порядке, установленным законодательством Республики
				Беларусь.
			</p>
			<p>
			...
			<ul>
				<li>
					Предоставить информацию о персональных данных, необходимую для пользования Сайтом интернет-ресурса.
				</li>
				<li>
			...
			<p>
				...
				законодательством Республики Беларусь, за исключением случаев, предусмотренных п.п. 5.2., 5.3. и 6.2.
			...
			<p>
				...
				Интернет-ресурса и Администрацией сайта, обязательным является предъявление претензии (письменного
				предложения о добровольном урегулировании спора).
			</p>
			<p>
				8.2. Получатель претензии в течение 30 рабочих дней со дня получения претензии, письменно уведомляет
				заявителя претензии о результатах рассмотрения претензии.
			</p>
			<p>
				8.3. При не достижении соглашения спор будет передан на рассмотрение в суд в соответствии с действующим
			...
			<p>
				...
				интернет-ресурса, если иное не предусмотрено новой редакцией Политики конфиденциальности.
			</p>
			<p>
				9.3. Все предложения или вопросы по настоящей Политике конфиденциальности следует сообщать по адресу
				электронной почты: {SITE_OPERATOR.privacyContactEmail}
			</p>
			<p>
				9.4. Действующая Политика конфиденциальности размещена на странице по адресу
				{SITE_PUBLIC_ORIGIN}/.Политика-конфиденциальности
			</p>
		</div>
