					...
					{news.map((item, index) => (
						...
						>
							<div className={stylesToUse.content__image}>
								<NextImage src={item.image} alt={item.title} width={400} height={400} />
							</div>
							<div className={stylesToUse.content__wrapper}>
								...
								<div className={stylesToUse.content__date}>{item.date}</div>
								<div id={`news-${index}`} className={stylesToUse.content__text}>
